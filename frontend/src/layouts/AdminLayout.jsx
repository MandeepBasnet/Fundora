...
import { LayoutDashboard, Users, Flag, Settings, LogOut, ShieldAlert, CheckCircle2, DollarSign } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 hidden lg:flex lg:flex-col shrink-0">
        <nav className="p-4 space-y-1 flex-1 pt-6">
          ...
          <NavItem to="/admin/fund-disbursements" icon={DollarSign} label="Fund Disbursements" />
