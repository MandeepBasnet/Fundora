      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            {authUser && (
              <Link to={authUser?.role === 'creator' ? '/creator/messages' : '/dashboard/messages'} className="p-2 text-gray-700 hover:text-sky-600 transition-colors relative" title="Messages">
